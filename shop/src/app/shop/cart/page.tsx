  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Not authenticated, which is fine for viewing cart
        setUser(null);
      } finally {
                              ...
                              target.parentElement!.innerHTML = `
                                <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-foreground/5 to-foreground/10">
                                  <div class="text-center">
                                    <div class="w-10 h-10 bg-foreground/10 rounded-lg mx-auto mb-1 flex items-center justify-center">
                                      <svg class="w-5 h-5 text-foreground/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                      </svg>
                                    </div>
                                    <p class="text-xs font-medium text-foreground/50">No Image</p>
                                  </div>
                                </div>
                              `;
                            }}
