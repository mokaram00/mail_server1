...
interface EditCouponDialogProps {
  ...
  onClose: () => void;
  coupon: Coupon | null;
  onEditCoupon: (event: React.FormEvent, couponData: FormData) => Promise<void>;
...
export default function EditCouponDialog({ isOpen, onClose, coupon, onEditCoupon, setErrorMessage, setSuccessMessage }: EditCouponDialogProps) {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Edit Form submission - couponForm state:', couponForm); // Debug log
      ...
      console.log('Edit FormData contents:'); // Debug log
